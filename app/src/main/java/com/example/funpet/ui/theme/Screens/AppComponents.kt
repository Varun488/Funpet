...
fun ButtonComponent(
    ...
    Button(
       ...
       TextComponent(value = "Go to details screen", textSize = 18.sp, colorValue = Color.White)
    }
    ...
    Card(
        ...
        elevation = CardDefaults.cardElevation(4.dp)
         ...
         Column(
            ...
            Image(painter = painterResource(id = R.drawable.open), contentDescription = "open")
             Spacer(modifier = Modifier.size(24.dp))
             TextWithShadow(value = value)
             Spacer(modifier = Modifier.size(24.dp))
             Image(painter = painterResource(id = R.drawable.quote), contentDescription = "quote")
         }
    }
}
